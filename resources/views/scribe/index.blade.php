    ...
    <div id="toc">
                ...
                <li class="tocify-item level-1" data-unique="dashboard">
                    <a href="#dashboard">Dashboard</a>
                                ...
                                <a href="#dashboard-GETapi-dashboard">Dashboard stats</a>
                            </li>
                                                                        </ul>
                            </ul>
                ...
                <li class="tocify-item level-1" data-unique="projects">
                    <a href="#projects">Projects</a>
                                ...
                                <a href="#projects-POSTapi-projects">Create a project</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="projects-GETapi-projects--id-">
                                <a href="#projects-GETapi-projects--id-">View a project</a>
                            </li>
                ...
                <li class="tocify-item level-1" data-unique="tasks">
                    <a href="#tasks">Tasks</a>
                                    ...
                                    <ul id="tocify-subheader-tasks" class="tocify-subheader">
                                                    <li class="tocify-item level-2" data-unique="tasks-GETapi-projects--project_id--tasks">
                                <a href="#tasks-GETapi-projects--project_id--tasks">List tasks of a project</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="tasks-POSTapi-projects--project_id--tasks">
                                <a href="#tasks-POSTapi-projects--project_id--tasks">Create a task</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="tasks-GETapi-tasks">
                                <a href="#tasks-GETapi-tasks">List all tasks</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="tasks-GETapi-tasks--id-">
                                <a href="#tasks-GETapi-tasks--id-">View a task</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="tasks-PUTapi-tasks--id-">
                                <a href="#tasks-PUTapi-tasks--id-">Update a task</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="tasks-DELETEapi-tasks--id-">
                                <a href="#tasks-DELETEapi-tasks--id-">Delete a task</a>
                            </li>
                                                                        </ul>
                            </ul>
            </div>
...
<p>Get your token from the <b>/api/register</b> or <b>/api/login</b> endpoints and send it as a Bearer token.</p>
...
<p>Create a new account and get an API token.</p>
...
<p>Exchange credentials for an API token.</p>
...
<p>Example: <code>application/json</code></p>
                ...
                <h1 id="dashboard">Dashboard</h1>
                                ...
                                <h2 id="dashboard-GETapi-dashboard">Dashboard stats</h2>

<p>
<small class="badge badge-darkred">requires authentication</small>
</p>

<p>Returns project and task counters for the authenticated user.</p>
...
<p>Example: <code>application/json</code></p>
    ...
    <p>Manage the authenticated user's projects.</p>
...
<i>optional</i> &nbsp;
 &nbsp;
    ...
    <br>
<p>Filter by status: active, completed or archived. Example: <code>active</code></p>
            </div>
                                    <div style="padding-left: 28px; clear: unset;">
...
<p>Must be at least 1. Must not be greater than 100. Example: <code>21</code></p>
                    ...
                    <h2 id="projects-POSTapi-projects">Create a project</h2>
...
<ul style="list-style-type: square;"><li><code>active</code></li> <li><code>completed</code></li> <li><code>archived</code></li></ul>
                    ...
                    <h2 id="projects-GETapi-projects--id-">View a project</h2>
...
<p>The ID of the project. Example: <code>1</code></p>
    ...
    <p>Manage tasks inside the authenticated user's projects.</p>

                                <h2 id="tasks-GETapi-projects--project_id--tasks">List tasks of a project</h2>
...
&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="Authorization" class="auth-value"               data-endpoint="GETapi-projects--project_id--tasks"
               value="Bearer {YOUR_TOKEN}"
               data-component="header">
    <br>
<p>Example: <code>Bearer {YOUR_TOKEN}</code></p>
...
<i>optional</i> &nbsp;
 &nbsp;
               ...
               data-component="query">
    <br>
<p>Filter by status: todo, in_progress or done. Example: <code>done</code></p>
            </div>
                                    <div style="padding-left: 28px; clear: unset;">
...
<i>optional</i> &nbsp;
 &nbsp;
               ...
               data-component="query">
    <br>
<p>Filter by priority: low, medium or high. Example: <code>medium</code></p>
            </div>
                                    <div style="padding-left: 28px; clear: unset;">
...
<i>optional</i> &nbsp;
 &nbsp;
               ...
               data-component="query">
    <br>
<p>Search in task titles. Example: <code>bug</code></p>
            </div>
                                    <div style="padding-left: 28px; clear: unset;">
                <b style="line-height: 2;"><code>per_page</code></b>&nbsp;&nbsp;
<small>integer</small>&nbsp;
<i>optional</i> &nbsp;
 &nbsp;
                <input type="number" style="display: none"
               step="any"               name="per_page"                data-endpoint="GETapi-projects--project_id--tasks"
               value="10"
               data-component="query">
    <br>
<p>Results per page (max 100). Example: <code>10</code></p>
                    ...
                    <h2 id="tasks-POSTapi-projects--project_id--tasks">Create a task</h2>
...
&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="Authorization" class="auth-value"               data-endpoint="POSTapi-projects--project_id--tasks"
               value="Bearer {YOUR_TOKEN}"
               data-component="header">
    <br>
<p>Example: <code>Bearer {YOUR_TOKEN}</code></p>
...
<p>Must be a valid date. Example: <code>2026-08-02T02:57:31</code></p>
                    ...
                    <h2 id="tasks-GETapi-tasks">List all tasks</h2>

<p>
<small class="badge badge-darkred">requires authentication</small>
</p>

<p>Returns tasks across all of the user's projects.</p>
...
<i>optional</i> &nbsp;
 &nbsp;
               ...
               data-component="query">
    <br>
<p>Filter by status: todo, in_progress or done. Example: <code>todo</code></p>
            </div>
                                    <div style="padding-left: 28px; clear: unset;">
                <b style="line-height: 2;"><code>priority</code></b>&nbsp;&nbsp;
<small>string</small>&nbsp;
<i>optional</i> &nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="priority"                data-endpoint="GETapi-tasks"
               value="high"
               data-component="query">
    <br>
<p>Filter by priority: low, medium or high. Example: <code>high</code></p>
            </div>
                                    <div style="padding-left: 28px; clear: unset;">
                <b style="line-height: 2;"><code>search</code></b>&nbsp;&nbsp;
<small>string</small>&nbsp;
<i>optional</i> &nbsp;
 &nbsp;
               ...
               data-component="query">
    <br>
<p>Search in task titles. Example: <code>deploy</code></p>
            </div>
                                    <div style="padding-left: 28px; clear: unset;">
                <b style="line-height: 2;"><code>per_page</code></b>&nbsp;&nbsp;
<small>integer</small>&nbsp;
...
<p>Results per page (max 100). Example: <code>10</code></p>
                    ...
                    <h2 id="tasks-GETapi-tasks--id-">View a task</h2>
...
<p>The ID of the task. Example: <code>1</code></p>
                    ...
                    <h2 id="tasks-PUTapi-tasks--id-">Update a task</h2>
...
<p>Must be a valid date. Example: <code>2026-08-02T02:57:31</code></p>
                    ...
                    <h2 id="tasks-DELETEapi-tasks--id-">Delete a task</h2>
